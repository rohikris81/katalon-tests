...
Mobile.comment('Test Case No. - LIVING-T1008')
...
Mobile.sendKeys(findTestObject('Living/Onboarding/txt Email Address'), GlobalVariable.G_memberusername)
...
Mobile.verifyElementVisible(findTestObject('Object Repository/Living/Onboarding/btn Password Save'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/Living/Onboarding/btn Password Save'), 0)
