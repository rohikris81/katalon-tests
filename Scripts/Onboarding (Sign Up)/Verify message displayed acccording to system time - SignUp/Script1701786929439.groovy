...
Mobile.comment('Test Case No. - LIVING-T1004')
...
Mobile.comment('Asssertions started.........')
	...
	if(ctime > 00 && ctime < 12)
			{
				Mobile.verifyEqual(txtvalueonui, GlobalVariable.G_morning_messageS)
			}
		else if(ctime > 12 && ctime < 18)
			{
				Mobile.verifyEqual(txtvalueonui, GlobalVariable.G_afternoon_messageS)				
			}
		else if(ctime > 18 && ctime < 23)
			{
				Mobile.verifyEqual(txtvalueonui, GlobalVariable.G_evening_messageS)			
			}
