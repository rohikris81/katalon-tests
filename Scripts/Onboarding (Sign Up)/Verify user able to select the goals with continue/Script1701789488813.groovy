...
Mobile.comment('Test Case No. - LIVING-T1005')
...
Mobile.sendKeys(findTestObject('Living/Onboarding/txt Email Address'), 'rgauto'+CustomKeywords.'living.Common.generaterstring'()+'@auto334.org')
...
Mobile.delay(GlobalVariable.G_minitimeout)

//Mobile.tap(findTestObject('Object Repository/Living/Onboarding/lbl User Goal'), 0)

def gl = CustomKeywords.'living.Common.getListOfElements'(GlobalVariable.UserGoalList)

	for (WebElement element : gl) {
		element.click()
...
Mobile.verifyElementVisible(findTestObject('Object Repository/Living/Onboarding/btn Lets Begin'), 0)
