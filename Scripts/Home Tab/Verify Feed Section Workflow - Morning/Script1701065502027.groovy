...
Mobile.comment('Test Case to execute - Verify Feed Section Player - Morning')
...
Mobile.tap(findTestObject('Living/Home Tab/Morning Feeds'), 0)
...
Mobile.verifyElementExist(findTestObject('Object Repository/Living/Home Tab/Mimimize Player Screen'), 0)
