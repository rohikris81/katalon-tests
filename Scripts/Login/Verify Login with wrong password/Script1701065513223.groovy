...
Mobile.comment('Test Case to execute - SN1012')
...
CustomKeywords.'living.Elements.loginuser'(GlobalVariable.G_memberusername, wrongpassword)

Mobile.comment('Asssertions started.........')

Mobile.verifyElementVisible(findTestObject('Living/btn Login'), 0)
