...
Mobile.comment('Test Case to execute - SN1010')
...
CustomKeywords.'living.Elements.loginuser'(wrongemailformat, GlobalVariable.G_memberpassword)

Mobile.comment('Asssertions started.........')

Mobile.verifyElementVisible(findTestObject('Living/lbl valid email id message'), 0)

Mobile.verifyElementExist(findTestObject('Living/lbl valid email id message'), 0)
